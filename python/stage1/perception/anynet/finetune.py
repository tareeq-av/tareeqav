...
def main():
    ...
    print('train left image', len(train_left_img))
    print('train right image', len(train_right_img))
    print('train left disp', len(train_left_disp))
    print('test left img',len(test_left_img))
    print('test_right_img', len(test_right_img))
    print('test left disp',len(test_left_disp))
